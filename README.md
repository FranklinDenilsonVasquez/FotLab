...
Welcome! FotLab is a data-driven project that fetches NFL statistics using an external API and stores the data in a PostgreSQL database. This project enables efficient tracking of key performance metrics such as quarterback touchdowns, team wins, and player statistics, making it ideal for sports analysts, developers, and NFL enthusiasts.
